...
def svg_grid(rows: int, cols: int, cell_size: int, offset_x: int = 0, offset_y: int = 0) -> str:
    """
...
def svg_rect(x: int, y: int, w: int, h: int, fill: str = "none", stroke: str = "black", stroke_width: int = 1) -> str:
    """Render an SVG <rect>."""
    return (
