...
class GoogleOAuth(OAuthProvider):
    ...
    TOKEN_URL = "https://oauth2.googleapis.com/token"  # noqa: S105 - OAuth token endpoint URL, not a password
...
class GitHubOAuth(OAuthProvider):
    ...
    TOKEN_URL = "https://github.com/login/oauth/access_token"  # noqa: S105 - OAuth token endpoint URL, not a password
