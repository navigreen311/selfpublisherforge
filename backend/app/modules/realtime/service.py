...
class RealtimeService:
    ...
    async def send_to_user(self, channel: WSChannel, room_id: str, user_id: str, message: dict[str, Any]) -> None:
    ...
    async def disconnect_user(self, channel: WSChannel, room_id: str, user_id: str) -> None:
