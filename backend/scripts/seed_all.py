...
def main() -> int:
    ...
    with httpx.Client(timeout=30.0, follow_redirects=True) as client:
        ...
        books = [
            {
                ...
                "keywords": ["lighthouse", "mystery", "sea"],
            },
            {
                "title": "Cozy Cabin Murders",
                "book_type": "fiction",
                "genre": "Cozy Mystery",
                "subgenre": "Whodunit",
                "target_word_count": 70000,
                "keywords": ["cozy", "mystery", "cabin"],
            },
            {
                "title": "Six-Figure Self-Publishing",
                "book_type": "nonfiction",
                "genre": "Business",
                "subgenre": "Marketing",
                "target_word_count": 45000,
                "keywords": ["kdp", "marketing", "indie"],
            },
            {
                "title": "Starlight Academy",
                "book_type": "fiction",
                "genre": "YA Fantasy",
                "subgenre": "Magic School",
                "target_word_count": 90000,
                "keywords": ["fantasy", "ya", "magic"],
            },
        ]
        ...
        for plat, name in [
            ("kdp", "My KDP Account"),
            ("ingram_spark", "IngramSpark Print"),
        ...
        if book_id:
            ...
            if pl and pl.get("id"):
                for i, t in enumerate(
                    ["Final copyedit", "Cover finalization", "EPUB + PDF export", "KDP metadata upload"]
                ):
                    post("pipelines", f"/pipelines/{pl['id']}/tasks", {"title": t, "order": i, "status": "pending"})

        # ---- Cover Design ----------------------------------------------------
        for t, g, mood in [
            ("The Last Lighthouse", "literary-fiction", "atmospheric, melancholic"),
            ...
            post(
                "covers",
                "/covers/generate",
                {"title": t, "author_name": "Ivan Carter", "genre": g, "platform": "amazon-kdp", "mood": mood},
            )
        ...
        if book_id:
            post(
                "product-page",
                "/product-page/blurb/ab-test",
                {
                    "book_id": book_id,
                    "name": "Lighthouse Blurb Test",
        ...
        post(
            ...
            "/marketing/email-sequences",
            {
                ...
                "description": "Build buzz before release day",
                "trigger_event": "signup",
                "emails": [
                    {
                        "template_type": "launch_announcement",
                        "subject": "My new book is coming!",
                        "body_html": "<p>Big news — release day is near.</p>",
                        "body_text": "Big news.",
                        "delay_days": 0,
                        "order_index": 0,
                    },
                    {
                        ...
                        "subject": "3 days to launch",
                        "body_html": "<p>Almost here!</p>",
                        "body_text": "Almost here!",
                        "delay_days": 4,
                        "order_index": 1,
                    },
                ],
        ...
        for name, ctype in [
            ("Holiday Promo — Facebook", "facebook_feed"),
        ...
        for name, strat, fmt, tgt in [
            ("Competitive eBook Pricing", "competitive_match", "ebook", 4.99),
            ...
            post(
                ...
                {
                    "name": name,
                    "description": "Auto pricing strategy",
                    "strategy": strat,
                    "book_format": fmt,
                    "min_price": 2.99,
                    "max_price": 19.99,
        ...
        post(
            "specialty:coloring",
            "/specialty/coloring-books",
            {
                "title": "Calm Forest Coloring",
                "audience": "adults",
                "page_count": 30,
                "trim_size": "8.5x11",
                "line_style": "clean-outlines",
                "line_weight": 2.0,
                "complexity": 0.5,
        ...
        post(
            "specialty:puzzle",
            "/specialty/puzzle-books",
            {
                "title": "Big Book of Word Search",
                "audience": "adults",
                "puzzle_config": [
                    {"puzzle_type": "word-search", "quantity": 20, "difficulty": "medium", "grid_size": "15x15"}
                ],
                "difficulty_mode": "progressive",
                "trim_size": "8.5x11",
                "word_difficulty": "standard",
                "clue_style": "standard",
                "answer_key_position": "back-of-book",
        ...
        post(
            "specialty:cookbook",
            "/specialty/cookbook-books",
            {
                "title": "Weeknight Comfort Kitchen",
                "author": "Ivan Carter",
        ...
        if book_id:
            post(
                ...
                {
                    "book_id": book_id,
                    "title": "The Last Lighthouse (Audiobook)",
                    "output_format": "mp3",
                    "sample_rate": 44100,
                    "bit_rate": 192,
                    "channels": 1,
        ...
        for m in range(6):  # six months of history
            ...
            for t, units, price in [
                (titles[0] if titles else "The Last Lighthouse", 120 - m * 8, 4.99),
        ...
        if agent_id:
            post(
                ...
                {
                    "agent_id": agent_id,
                    "title": "Research cozy mystery market 2026",
                    "description": "Analyze trends and comps",
                    "priority": "medium",
            ...
            post(
                ...
                {
                    "name": "Launch Prep",
                    "description": "Multi-step pre-launch",
        ...
        # ---- Settings: API key ----------------------------------------------
        post("settings:api-keys", "/settings/api-keys", {"name": "Local Dev Key", "permissions": ["read", "write"]})
