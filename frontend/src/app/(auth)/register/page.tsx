...
export const metadata: Metadata = createMetadata({
  ...
  description: "Join SelfPublisherForge and start your self-publishing journey. Get AI-powered tools, analytics, and automation to publish and grow your books.",
});
  ...
  return (
    <Card className="w-full max-w-lg mx-auto px-4 sm:px-6">
      <CardHeader className="text-center px-4 sm:px-6">
        ...
        <CardDescription className="text-sm sm:text-base">Start your self-publishing journey today</CardDescription>
      </CardHeader>
          ...
          <div className="space-y-1.5">
            ...
            {password && (
              <div
                ...
                className="grid grid-cols-1 sm:grid-cols-2 gap-1 sm:gap-2 mt-2"
              >
